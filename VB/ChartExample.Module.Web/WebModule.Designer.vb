...
Imports System
Namespace ChartExample.Module.Web
	Partial Public Class ChartExampleAspNetModule
		''' <summary> 
		...
		Private Sub InitializeComponent()
			' 
			' ChartExampleAspNetModule
			' 
			Me.RequiredModuleTypes.Add(GetType(ChartExample.Module.ChartExampleModule))
